...
$(document).ready(function() {
	// on hover hide clicked button Account Lang Currency
	for(var dropdown of $('.top-menu-item.dropdown')){
		$(dropdown).hover(function(){
			for (var element of $('.wheel-top-menu .top-menu-item > button[aria-expanded=true]')){
					$(element).click();
		}
	});
	}
